...
```{r}
prop_fish_plot<-ggplot(sub_dat, aes(x = prop_fish , y = (ME_score/100), label = labels, col = avg_diff_me)) +
...
```{r}
ggsave(here("figures/Prop_fish_ME_avg_diff_plot.tiff"), dpi=300,  device = "tiff", width = 22, height=18, units = "cm")
```
